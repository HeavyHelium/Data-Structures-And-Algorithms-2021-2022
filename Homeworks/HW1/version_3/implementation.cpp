...
//				{
//					// ready to go
//					std::cout << current_client.get_id() << " " << last_arrived_good << " "
...
//				std::cout << current_client.get_id() << " " << current_client.max_departure_time() << " "
...
//        {
//            std::cout << last_client_id++ << " " << c.schweppes << " " << c.banana << c.arriveMinute << std::endl;
