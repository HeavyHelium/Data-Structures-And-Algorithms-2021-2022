...
60 50 50 50*/
		...
		/*
		SECTION("Zeroth and first depart, second and third arrive") {
			store.advanceTo(60);
			INFO("First resources should arrive");
			...
			INFO("Second arrives and workers must be sent for banana and schweppes");
