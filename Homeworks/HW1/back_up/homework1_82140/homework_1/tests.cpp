#define TESTS /// this macro enables the tests verision of my solution
#define CATCH_CONFIG_MAIN

// at the end of the file I have included my own tests as a header, nothing else is modified

#include "interface.h"
#include "implementation.h" // my solution is a header
#include "catch.hpp"		
